                            ...
                            <div className="space-y-6 pt-6 border-t border-gray-100">
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    {user ? (
                                        ...
                                        <button onClick={() => setShowLoginModal(true)} className="w-full h-10 border border-gray-900 text-gray-900 rounded-sm font-medium uppercase tracking-wide text-xs hover:bg-gray-50 flex items-center justify-center transition-colors">
                                            Go to Cart <ArrowRight size={14} className="ml-2" />
                                        </button>
                                    )}
                                </div>
